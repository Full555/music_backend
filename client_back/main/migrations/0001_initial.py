    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('music', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.music')),
                ('playlist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tracks', to='main.playlist')),
            ],
        ),
        migrations.AddField(
            model_name='music',
            name='type_music',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='musics', to='main.typemusic'),
        ),
        migrations.CreateModel(
            name='Favorite',
            fields=[
